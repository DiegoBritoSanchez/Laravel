      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          <a href="/" class="flex flex-shrink-0 items-center">
            <img class="block h-8 w-auto lg:hidden" src="https://logo-download.com/wp-content/data/images/svg/Babylon.js-logo.svg" alt="Your Company">
            <img class="hidden h-8 w-auto lg:block" src="https://logo-download.com/wp-content/data/images/svg/Babylon.js-logo.svg" alt="Your Company">
          </a>
